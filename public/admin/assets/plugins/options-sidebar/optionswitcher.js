$(document).ready(function () {
        ...
        <div class="right-sidebar-container-2">
          <div class="slim-scroll-right-sidebar-2">
            ...
            <div class="right-sidebar-2-header">
              <h2>${lang.t('Environment Settings')}</h2>
              <p>${lang.t('Layout Preview Settings')}</p>
            ...
            <div class="right-sidebar-2-body" data-simplebar>
              <span class="right-sidebar-2-subtitle">${lang.t('Header Layout')}</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-header-fixed-to btn-right-sidebar-2-active">${lang.t('Fixed')}</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-header-static-to">${lang.t('Static')}</a>
              </div>

              <span class="right-sidebar-2-subtitle">${lang.t('Sidebar Layout')}</span>
              <div class="no-col-space">
                <select class="right-sidebar-2-select" id="sidebar-option-select">
                  <option value="ec-sidebar-fixed">${lang.t('Fixed Default')}</option>
                  <option value="ec-sidebar-fixed-minified">${lang.t('Fixed Minified')}</option>
                  <option value="ec-sidebar-fixed-offcanvas">${lang.t('Fixed Offcanvas')}</option>
                  <option value="ec-sidebar-static">${lang.t('Static Default')}</option>
                  <option value="ec-sidebar-static-minified">${lang.t('Static Minified')}</option>
                  <option value="ec-sidebar-static-offcanvas">${lang.t('Static Offcanvas')}</option>
                </select>
              </div>

              <span class="right-sidebar-2-subtitle">${lang.t('Header Background')}</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active ec-header-light-to">${lang.t('Light')}</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-header-dark-to">${lang.t('Dark')}</a>
              </div>

              <span class="right-sidebar-2-subtitle">${lang.t('Navigation Background')}</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active ec-sidebar-light-to">${lang.t('Light')}</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-sidebar-dark-to">${lang.t('Dark')}</a>
              </div>

              <span class="right-sidebar-2-subtitle">${lang.t('Spacing Layout')}</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active default-spacing-to">${lang.t('Default')}</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 compact-spacing-to">${lang.t('Compact')}</a>
              </div>
              <div class="d-flex justify-content-center">
                <div id="reset-options" style="width: auto; cursor: pointer" class="btn-right-sidebar-2 btn-reset">${lang.t('Reset')}</div>
              </div>
            </div>
          </div>
        </div>
    ...
    function resetModule() {
        ...
        location.reload(); // Reload the page after resetting options
    }
    ...
    header_static.click(function () {
        ...
        body.removeClass('ec-header-fixed').addClass('ec-header-static')
    ...
    header_fixed.click(function () {
        ...
        body.removeClass('ec-header-static').addClass('ec-header-fixed')
        //Store in local storage
    ...
    default_spacing.click(function () {
        ...
        //Store in local storage
        setModule("navigationSpacing", "default-spacing")
    });

    //Click for current options
    if (activeModule.navigationSpacing === "default-spacing") {
