        ...
        {{-- <div class="ec-sidebar-slider-cat">
            ...
            <div class="ec-sb-pro-sl">
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{asset('theme/assets/images/product-image/1.jpg')}}" alt="product" /></a>
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{asset('theme/assets/images/product-image/2.jpg')}}" alt="product" /></a>
                        <div class="ec-pro-content">
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{asset('theme/assets/images/product-image/3.jpg')}}" alt="product" /></a>
                        <div class="ec-pro-content">
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{asset('theme/assets/images/product-image/4.jpg')}}" alt="product" /></a>
                        <div class="ec-pro-content">
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{asset('theme/assets/images/product-image/5.jpg')}}" alt="product" /></a>
                        <div class="ec-pro-content">
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{asset('theme/assets/images/product-image/6.jpg')}}" alt="product" /></a>
                        <div class="ec-pro-content">
                ...
                <div>
                    <div class="ec-sb-pro-sl-item">
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="{{asset('theme/assets/images/product-image/7.jpg')}}" alt="product" /></a>
                        <div class="ec-pro-content">
