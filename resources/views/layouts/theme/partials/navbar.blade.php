                        ...
                        <div class="ec-header-user dropdown">
                            @if (Auth::check())
                                <button class="dropdown-toggle" data-bs-toggle="dropdown">
                                    <i class="fi-rr-user" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ Auth::user()->name.' '.Auth::user()->lastname }}"></i>
                                </button>
                            @else
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                @guest
                                    @if (Route::has('login'))
                                        <li><a class="dropdown-item" href="{{ route('login') }}">{{ __('Login') }}</a>
                                        </li>
                                    @endif
                                    ...
                                    @endif
                                @else
                                    <li><a class="dropdown-item" href="{{ route('home') }}">{{ __('My Account') }}</a>
                                    </li>
                                    ...
                                    <li>
                                        <ul class="ec-main-banner w-100">
                                            ...
                                            <li><a class="p-0" href="shop-left-sidebar-col-4.html"><img
                                                        class="img-responsive"
                                                        src="{{ asset('theme/assets/images/menu-banner/2.jpg') }}"
                                                        alt=""></a></li>
                                            <li><a class="p-0" href="shop-right-sidebar-col-3.html"><img
                                                        class="img-responsive"
                                                        src="{{ asset('theme/assets/images/menu-banner/3.jpg') }}"
                                                        alt=""></a></li>
                                            <li><a class="p-0" href="shop-right-sidebar-col-4.html"><img
                                                        class="img-responsive"
                                                        src="{{ asset('theme/assets/images/menu-banner/4.jpg') }}"
                                                        alt=""></a></li>
                                        </ul>
                                    </li>
                                </ul>
