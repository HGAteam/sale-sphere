                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 mb-4">
                                ...
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="{{__('Email Account')}}" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
