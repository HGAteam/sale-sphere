...
@section('content')
    @include('layouts.admin.partials.breadcrumb', [
        ...
        ($pageTitle = trans('Brands')),
        ($modalLink = '#'),
        ($modalName = trans('Add Brand')),
        ($href = ''),
    ])
            ...
            <div class="ec-cat-list card card-default">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="brands-data-table" class="table">
                            <thead>
                                <tr>
                                    <th>#</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editBrandModalLabel">{{ __('Edit Brand') }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="editBrandForm">
                        ...
                        <div class="form-group row mb-6">
                            <label for="coverImageEdit" class="col-sm-4 col-lg-4">{{ __('Brand Image') }}
                                <div class="">
                                    <!-- Imagen por defecto -->
                            ...
                            <div class="col-sm-8 col-lg-8">
                                <div class="custom-file my-8">
                                    <input type="file" class="custom-file-input" id="coverImageEdit" name="edit_image">
                                    <label class="custom-file-label" for="coverImageEdit" id="customFileLabelEditImage">{{ __('Choose file') }}...</label>
                                </div>
                            </div>
                        </div>
                        <!-- INPUTS -->
...
@section('scripts')
    ...
    <script src="{{ asset('admin/assets/js/custom/brands/table.js') }}"></script>
    <script src="{{ asset('admin/assets/js/custom/brands/add.js') }}"></script>
    <script src="{{ asset('admin/assets/js/custom/brands/update.js') }}"></script>
